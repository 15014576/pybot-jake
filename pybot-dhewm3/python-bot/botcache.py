...
class cache:
    ...
    #
    #  armor - return the bots armor.
    #

    def armor (self):
        if not self._dict.has_key ('armor'):
            self._dict['armor'] = self._basic.armor ()
        return self._dict['armor']

    #
    #  getCurrentWeapon - return the bots current weapon.
    #

    def getCurrentWeapon (self):
        if not self._dict.has_key ('getCurrentWeapon'):
            self._dict['getCurrentWeapon'] = self._basic.getCurrentWeapon ()
        return self._dict['getCurrentWeapon']
