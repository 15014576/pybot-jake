...
class bot:
    ...
    #
    # getCurrentWeapon - returns the bots current weapon.
    #

    def getCurrentWeapon (self):
        return self._cache.getCurrentWeapon ()
    ...
    #
    #  stop_firing - stops firing weapon
    #
    ...
    #
    #  reload_weapon - reloads current weapon
    #
